...
class wputh__contact {
    ...
    public function set_options($options) {
        ...
        $this->target_email = apply_filters('wputh_contact_email', $this->target_email, $this->options);

        $this->has_upload = false;
        $this->contact__success = apply_filters('wputh_contact_success', '<p class="contact-success">' . __('Thank you for your message!', 'wputh') . '</p>', $this->options);
    ...
    public function page_content($hide_wrapper = false, $form_id = false) {
        ...
        $this->content_contact .= '<input type="hidden" name="form_id" value="' . esc_attr($form_id) . '" />';
...
function wputh__contact__content($atts) {
    $id = isset($atts['id']) ? $atts['id'] : 'default';
    do_action('wputh_contact_content', false, $id);
}
