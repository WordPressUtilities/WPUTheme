...
function wputh_common_libraries() {
    ...
    if (apply_filters('wputh_common_libraries__swiper', false)) {
        ...
        wp_localize_script('wputh-swiper-init-js', 'wputh_swiper_init_js', array(
            'paginationBulletMessage' => __('Go to slide {{index}}', 'wputh'),
            'firstSlideMessage' => __('This is the first slide', 'wputh'),
            'lastSlideMessage' => __('This is the last slide', 'wputh'),
            'prevSlideMessage' => __('Previous slide', 'wputh'),
            'nextSlideMessage' => __('Next slide', 'wputh')
        ));
