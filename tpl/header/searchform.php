...
<div class="search search--header header-search">
  <form role="search" method="get" id="header-search" class="search__form" action="<?php echo home_url(); ?>">
      <div class="search__inner">
          ...
          <input type="text" value="" name="s" id="s" class="search__input" placeholder="<?php echo esc_attr__( 'Enter your keywords...', 'wputh' ); ?>" title="<?php echo esc_attr__( 'Search by keywords', 'wputh' ); ?>" />
